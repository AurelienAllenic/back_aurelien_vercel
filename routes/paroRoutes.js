...
router.delete('/smart-links-v2/:id', auth, smartLinkV2Controller.deleteSmartLink);

// FOLDERS ROUTES

router.post('/add-smart-link-folder', auth, smartLinkFolderController.addFolder);
...
router.put('/smart-links-folder/:id', auth, smartLinkFolderController.updateFolder);
router.delete('/smart-links-folder/:id', auth, smartLinkFolderController.deleteFolder);
